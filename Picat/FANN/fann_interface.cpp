...
int picat_array_to_fann_array(TERM ta, fann_type *a) {
	for (int i = 0; i < picat_get_struct_arity(ta); i++) {
		a[i] = picat_get_float(picat_get_arg(i + 1, ta));
	}
...
extern "C" {
	...
	int pi_fann_create_sparse() {
		...
		int con_rate = picat_get_integer(c_rate);
	...
	int pi_fann_create_shortcut() {
		...
		if (num_layers) {
			anns[n_id] = fann_create_shortcut(num_layers, layers);
			free(layers);
	...
	int pi_fann_randomize_weights() {
		TERM nn = picat_get_call_arg(1, 3);
		TERM min = picat_get_call_arg(2, 3);
		TERM max = picat_get_call_arg(3, 3);
	...
	*/
	...
	int pi_fann_train_on_data() {
		...
		TERM d_err = picat_get_call_arg(5, 5);
	...
	*/
	...
	int pi_fann_scale_train() {
		...
		fann_scale_train(ann, training_data[picat_get_integer(did)]);
	...
	int pi_fann_set_input_scaling_params() {
		...
		TERM min = picat_get_call_arg(3, 5);
		TERM max = picat_get_call_arg(4, 5);
	...
	int pi_fann_set_scaling_params() {
		...
		float new_input_min = picat_get_float(i_min);
		float new_input_max = picat_get_float(i_max);
		float new_output_min = picat_get_float(o_min);
		float new_output_max = picat_get_float(o_max);
	...
	int pi_fann_scale_input() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM in = picat_get_call_arg(2, 2);
	...
	int pi_fann_scale_output() {	
		TERM nn = picat_get_call_arg(1, 2);
		TERM out = picat_get_call_arg(2, 2);
	...
	int pi_fann_descale_input() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM in = picat_get_call_arg(1, 1);
	...
	int pi_fann_descale_output() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM out = picat_get_call_arg(1, 1);
	...
	int pi_fann_set_learning_rate() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM rate = picat_get_call_arg(2, 2);
	...
	int pi_fann_get_train_stop_function() {
		...
		case FANN_STOPFUNC_BIT:
			return picat_unify(ret, picat_build_atom("FANN_STOPFUNC_BUT"));
		}
	}
	...
	int pi_fann_set_bit_fail_limit() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM limit = picat_get_call_arg(2, 2);
	...
	int pi_fann_set_quickdrop_decay() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM decay = picat_get_call_arg(2, 2);
	...
	int pi_fann_set_quickprop_mu() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM mu = picat_get_call_arg(2, 2);
	...
	int pi_fann_set_rprop_increase_factor() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM fact = picat_get_call_arg(2, 2);
	...
	int pi_fann_set_rprop_delta_min() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM delta = picat_get_call_arg(2, 2);
	...
	int pi_fann_set_sarprop_weight_decay_shift() {
		TERM nn = picat_get_call_arg(1, 2);
		TERM weight = picat_get_call_arg(2, 2);
...
extern "C" int fann_cpreds() {
	...
	insert_cpred((char*)"pi_fann_scale_input", 2, pi_fann_scale_input);
	insert_cpred((char*)"pi_fann_scale_output", 2, pi_fann_scale_output);
	insert_cpred((char*)"pi_fann_descale_input", 2, pi_fann_descale_input);
	insert_cpred((char*)"pi_fann_descale_output", 2, pi_fann_descale_output);
	...
	insert_cpred((char*)"pi_fann_set_bit_fail_limit", 2, pi_fann_set_bit_fail_limit);
	insert_cpred((char*)"pi_fann_get_quickdrop_decay", 2, pi_fann_get_quickdrop_decay);
	insert_cpred((char*)"pi_fann_set_quickdrop_decay", 2, pi_fann_set_quickdrop_decay);
